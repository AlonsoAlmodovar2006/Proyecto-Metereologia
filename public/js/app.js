...
function cargarDatosUltimas24horas() {
  ...
  datos.forEach(dato => lluviaAcumulada += Number(dato.lluvia));

  if (lluviaAcumulada == 0) lluviaAcumulada = null;
  ...
  document.querySelector('#current-rain').innerText = `${lluviaAcumulada ?? 0} mm`;
